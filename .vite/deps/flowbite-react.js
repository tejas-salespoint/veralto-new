...
function useHover(context, props) {
  ...
  const closeWithDelay = React3.useCallback(function(event, runElseBranch) {
...
function FloatingFocusManager(props) {
  ...
  const previouslyFocusedElementRef = React3.useRef(null);
  ...
  }), !isTypeableCombobox && renderDismissButton("start"), children, renderDismissButton("end"), shouldRenderGuards && React3.createElement(FocusGuard, {
    "data-type": "inside",
...
var TabsComponent = (0, import_react41.forwardRef)(({ children, className, onActiveTabChange, style = "default", theme: customTheme = {}, ...props }, ref) => {
  ...
  const tabs = (0, import_react41.useMemo)(() => import_react41.Children.map(import_react41.Children.toArray(children), ({ props: props2 }) => props2), [children]);
